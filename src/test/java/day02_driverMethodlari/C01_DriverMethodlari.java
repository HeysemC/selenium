...
public class C01_DriverMethodlari {
    ...
    public static void main(String[] args) throws InterruptedException {
        ...
        //Bunun icin her testin basina mutlaka driver objesi olusturacagiz
        ...
        //acilan sayfanin basliginin mazon icerdigini test edin
        ...
        if (expectedUrl.equals(actualUrl)){
            ...
            System.out.println("Url istediginiz deger de degil");
