 ...
 */
        ...
        driver.manage().deleteAllCookies();//Cookies silici stabil calismiyor
        ...
        driver.findElement(By.name("firstname")).sendKeys("Heysen"+ Keys.ENTER);

        driver.findElement(By.xpath("//input[@name='lastname']")).sendKeys("Caglibulanik"+Keys.ENTER);

        //driver.findElement(By.id("sex-0")).sendKeys(Keys.PAGE_DOWN);
